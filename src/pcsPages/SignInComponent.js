...
const SignInComponent = () => {
  return (
    <div className="relative mt-7 mb-7">
      <div className="flex justify-end bg-blue-300 drop-shadow-2xl rounded-2xl gap-24 h-[450px] lg:w-[85%] lg:ml-[6.3rem] left-0 right-0 relative"
      >
        ...
        >
          <h1 className="text-2xl font-bold absolute py-4">SIGN IN AS</h1>

          <Link to="/login-pcs" className="col-6 flex items-center hover:text-lg">
            <div
          ...
          <Link to="/login" className="col-6 flex items-center hover:text-lg">
            <div
              className="hover:bg-blue-100 py-3 my-1 clickable-item px-2 mx-1 hover:bg-opacity-60  hover:border-blue-500 rounded-lg justify-between"
              style={{
                // border: "2px solid #ffb284",
