...
const Footer = () => {
  return (
    <footer className=" text-gray-300 mt-4 text-left">
      <div className="container bg-gray-900 md:w-[95.1rem] mx-auto py-8 px-4 ml-4 md:ml-0 ">
